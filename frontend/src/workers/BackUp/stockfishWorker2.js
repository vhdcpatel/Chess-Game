...
self.Module = {
    locateFile: function (path) {
        ...
        // Map any .wasm file request to your actual WASM file
        if (path.endsWith('.wasm')) {
            const wasmPath = '/stockfish/stockfish-17-lite-single.wasm';
            console.log('Redirecting WASM request to:', wasmPath);
            return wasmPath;
        }

        // For other files, redirect to stockfish directory
        if (path !== 'stockfish-17-lite-single.js') {
